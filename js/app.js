(() => {
    ...
    class Popup {
        ...
        _openToHash() {
            ...
            if (this.youTubeCode) this.youTubeCode.replace("someString", "anotherString"); else console.error("YouTube code is null");
    ...
    class SelectConstructor {
        ...
        selectsActions(e) {
            ...
            const targetType = e.type;
            const isSelectElement = targetElement.closest(this.getSelectClass(this.selectClasses.classSelect)) || targetElement.closest(this.getSelectClass(this.selectClasses.classSelectTag));
            if (isSelectElement) {
    ...
    function initSliders() {
        if (document.querySelector(".new-receipts__slider")) new swiper_core_Swiper(".new-receipts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3.54,
            ...
            navigation: {
                prevEl: ".new-receipts__prev",
                nextEl: ".new-receipts__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".discounts__slider")) new swiper_core_Swiper(".discounts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3.54,
        ...
        if (document.querySelector(".might-like__slider")) new swiper_core_Swiper(".might-like__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3.54,
            ...
            speed: 800,
            navigation: {
                prevEl: ".might-like__prev",
                nextEl: ".might-like__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
...
***************************************************************************** */
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const subMenuItems = document.querySelectorAll(".menu__sub-item");
        document.querySelectorAll(".menu__nested-item");
        ...
        const catalogLink = document.querySelector(".menu__link");
        const subMenuList = document.querySelector(".menu__sub-list");
        const closeButton = document.querySelector(".menu__close");
        const menuLinks = document.querySelectorAll(".menu__link");
        menuLinks.forEach((link => {
            link.addEventListener("click", (() => {
                const openSubMenus = document.querySelectorAll(".menu__nested-list.open");
                openSubMenus.forEach((subMenu => {
                    subMenu.classList.remove("open");
                    const subLinks = subMenu.querySelectorAll(".menu__sub-link");
                    subLinks.forEach((subLink => {
                        subLink.style.color = "";
                    }));
                }));
                const menuItem = link.closest(".menu__item");
                const subMenu = menuItem.querySelector(".menu__nested-list");
                const subLinksInMenu = menuItem.querySelectorAll(".menu__sub-link");
                if (subMenu && subLinksInMenu.length > 0) {
                    subMenu.classList.add("open");
                    subLinksInMenu[0].style.color = "#000";
                    subLinksInMenu.forEach((subLink => {
                        subLink.addEventListener("click", (() => {
                            subLinksInMenu.forEach((sl => {
                                sl.style.color = "";
                            }));
                            subLink.style.color = "#000";
                        }));
                    }));
                }
            }));
        ...
        catalogLink.addEventListener("click", (event => {
            event.preventDefault();
            if (subMenuList.style.display === "block") closeSubMenu(subMenuList); else {
                closeAllSubMenus();
                openSubMenu(subMenuList);
                const womenSubMenu = document.querySelector(".menu__sub-item:nth-child(1) .menu__nested-list");
                if (womenSubMenu) openSubMenu(womenSubMenu);
            }
        }));
        subMenuItems.forEach((item => {
            const subLink = item.querySelector(".menu__sub-link");
            subLink.addEventListener("click", (event => {
                event.preventDefault();
                const clickedSubMenu = item.querySelector(".menu__nested-list");
                if (clickedSubMenu.style.display === "block") closeSubMenu(clickedSubMenu); else {
                    closeAllSubMenus();
        ...
        function closeAllSubMenus() {
            const openSubMenus = document.querySelectorAll(".menu__sub-item .menu__nested-list");
            openSubMenus.forEach((subMenu => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const textElement = document.querySelector(".etnodim__text.etnodim__text--big");
        if (textElement) {
            const text = textElement.textContent.trim();
            textElement.innerHTML = [ ...text ].map((char => `<span style="color: #000;">${char}</span>`)).join("");
            const spans = textElement.querySelectorAll("span");
            const images = document.querySelectorAll(".etnodim__image-first.etnodim__image-first--big, .etnodim__image-second.etnodim__image-second--big");
            function checkOverlap() {
                spans.forEach((span => {
                    const spanRect = span.getBoundingClientRect();
                    const isInImage = [ ...images ].some((image => {
                        const imageRect = image.getBoundingClientRect();
                        return spanRect.left >= imageRect.left && spanRect.top >= imageRect.top && spanRect.right <= imageRect.right && spanRect.bottom <= imageRect.bottom;
                    }));
                    span.style.color = isInImage ? "white" : "#000";
                }));
            }
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const textElement = document.querySelector(".etnodim__text");
        if (textElement) {
            const text = textElement.textContent.trim();
            textElement.innerHTML = [ ...text ].map((char => `<span style="color: #000;">${char}</span>`)).join("");
            const spans = textElement.querySelectorAll("span");
            const images = document.querySelectorAll(".etnodim__image-first, .etnodim__image-second");
            function checkOverlap() {
                spans.forEach((span => {
                    const spanRect = span.getBoundingClientRect();
                    const isInImage = [ ...images ].some((image => {
